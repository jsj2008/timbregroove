...
uniform mediump vec4 materialDiffuseColor0;
...
void main(void)
{
    ...
    mediump vec3 materialDiffuseColor = materialDiffuseColor0.xyz;
    ...
    highp vec2 deltaNormal = (texture2D(texture0, textureCoordinate * repetitions).xy - 0.5);
